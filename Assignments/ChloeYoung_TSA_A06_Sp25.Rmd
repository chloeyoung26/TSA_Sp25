...
Yes, the plots represent the simulated model. The significant spike at lag 1 followed by the gradual decay on the ACF plot relates to the MA(1) component of the model. The significant spikes at 12, 24, and 36 on the ACF confirm the SAR(1) component, and the fact that the seasonal spikes gradually decay reflect the seasonal AR(1) component. For the PACF, the spikes at 12, 24, and 36 also confirm the seasonal AR(1) component, and the lack of significant spikes as the lags go on is reflective of the MA(1) component. All in all, the ACF and PACF plots do reflect the model well. and the order is identifiable.
