...
ggplot(inflow_data_yearly, aes(x=my_year, y=inflow_data_yearly))+
  geom_line(color="blue")+
...
The p=value is 0.007 which is less then confidence level 0.05 so we reject the null hypothesis. This means that the time series isn't stationary and follows a trend. The Score being positive indicates that the trend is increasing.
